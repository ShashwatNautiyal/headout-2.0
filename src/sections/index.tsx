...
const allReview = [
  {
    review:
      'Very clear communication from the point of purchase to the pick-up. The driver was very friendly and helpful. The car was clean and comfortable. The driver was very friendly and helpful. The car was clean and comfortable.',
  ...
  {
    review:
      'Fantastic experience and show. A real live music experience. As I am not totally fluent in English I thought it would be a bit frustrating not to understand all script. But not, as songs take a big part of the session.',
