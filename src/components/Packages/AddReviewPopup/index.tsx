                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6  align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 justify-center items-center">
                    ...
                    >
                                      ...
                                      <p className='decoration-slate-50 flex justify-center items-center text-xs' style={{fontSize:13,textAlign:'left',color:'#778899'}}>Note: All reviews will be verified by our team </p>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
            </div>
