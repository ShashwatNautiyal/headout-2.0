...
const images = [
    {
        ...
        packageSrc: "https://www.headout.com/london-eye-tickets/standard-experience-tickets-to-the-london-eye-e-3336/",
    ...
    },
    {
        ...
        packageSrc: "https://www.headout.com/skydive-sydney-tickets/tandem-skydive-wollongong-15000-ft-e-10351/",
    ...
    },
    {
        ...
        packageSrc: "https://www.headout.com/gardens-by-the-bay-tickets/gardens-by-the-bay-direct-entry-tickets-e-7358/",
...
const CaraouselHome = () => {
    return (
        <Carousel swipeable={true} showArrows={true} autoPlay={false} showThumbs={false} showStatus={false} showIndicators={true} infiniteLoop={true}>
            {
